...
%
%   2019-03-19  test_Objects03.m uses Suction_Model_1_0c.m and structure
%   "Object" to include gravity & accelerations and torques
...
switch world_ver,
    ...
    case 3,
        ...
        box3.insert_pos     = [0.100 ; 0.250 ; 0];
        
        %       Box with CM at center, will be picked in the middle
        
        box4          = box1;
        box4.m        = 0.200;                  % [kg]  object mass
        box4.w        = box4.m * g;             % [N]   object weight
        box4.CM_x     = -box4.L/2;                  % [m]   relative CM position
        box4.CM       = [ box4.CM_x  box4.CM_y  box4.CM_z  ]';
        box4.insert_pos     = [0.350 ; 0.050 ; 0];
        
        %       Box with CM at center, will be picked in the middle
        
        box5          = box1;
        box5.m        = 0.100;                  % [kg]  object mass
        box5.w        = box5.m * g;             % [N]   object weight
        box5.CM_x     = -box5.L/2;                  % [m]   relative CM position
        box5.CM       = [ box5.CM_x  box5.CM_y  box5.CM_z  ]';
        box5.insert_pos     = [0.350 ; 0.150 ; 0];
        
        %       Box with CM at center, will be picked in the middle
        
        box6          = box1;
        box6.m        = 0.000;                  % [kg]  object mass
        box6.w        = box6.m * g;             % [N]   object weight
        box6.CM_x     = -box6.L/2;                  % [m]   relative CM position
        box6.CM       = [ box6.CM_x  box6.CM_y  box6.CM_z  ]';
        ...
        %         world       = addObject( world , cylinder1, cylinder1_insert_pos );
        %         world       = addObject( world , sphere1, sphere1_insert_pos );
        world       = addObject( empty , box1, box1.insert_pos );
        world       = addObject( world , box2, box2.insert_pos );
        world       = addObject( world , box3, box3.insert_pos );
        world       = addObject( world , box4, box4.insert_pos );
        world       = addObject( world , box5, box5.insert_pos );
        world       = addObject( world , box6, box6.insert_pos );
        %         world       = addObject( world , cylinder2, cylinder2_insert_pos );
        %         world       = addObject( world , cylinder2b, cylinder2b_insert_pos );
        %         world       = addObject( world , cylinder3, cylinder3_insert_pos );
        %         world       = addObject( world , cylinder3b, cylinder3b_insert_pos );
        ...
        all_PickPoints  = [ ...
            [0.100 + box1.L/2  0.050 + box1.W/2   0]    ; ...
            [0.100 + box2.L/2  0.150 + box2.W/2   0]    ; ...
            [0.100 + box3.L/2  0.250 + box3.W/2   0]    ; ...
            [0.100 + Suction.RO  0.250 + box3.W/2   0]    ; ...
            [0.350 + box1.L/2  0.050 + box4.W/2   0]    ; ...
            [0.350 + box2.L/2  0.150 + box5.W/2   0]    ; ...
            [0.350 + box3.L/2  0.250 + box6.W/2   0]    ; ...
            [0.350 + Suction.RO  0.250 + box6.W/2   0]    ; ...
            ];
...
N_metrics           = 6;    % number of metrics to record for each pick point
...
for pick_point_no = 1:N_pick,
    ...
    Score_TM    = Score_metric(4);
    Score_weight= Score_metric(5);
    ...
    disp(['Final Suction Cup Grasp Score_TM     = ' num2str( round(100*Score_TM)   ) ]);
    disp(['Final Suction Cup Grasp Score_weight = ' num2str( round(100*Score_weight)   ) ]);
    disp(' ');
...
for pick_point_no = 1:N_pick,
    ...
    Score_string    = num2str( All_Metrics_Percent( pick_point_no, 2:6 ) ); % Note! ABB has ** REMOVED std(lipZ) ***, Score, Score_amp, Score_freq
...
save result_test_Objects03
disp('Please run ">> generateHeatMap02" manually....');
