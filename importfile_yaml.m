function ppmove = importfile_yaml(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   PPMOVE = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   PPMOVE = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   ppmove = importfile('0_ppmove.result.yaml', 1, 49);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/03/01 07:52:49
