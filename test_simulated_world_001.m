...
depth_scale     = 11e-6 / 2%* 2;     % Note! Simulated object size is 2x real object size
...
cy  =   Iheight / 2;
s   =   0;
F   = 40 %80 %20;    % [mm] camera focal length
%   Sensor size
Sx  = 23.66;
Sy  = 13.3;
